...
document.getElementById("conversationBtn").onclick = () => {
    ...
    ds.postRaw("/conversation/deployment_queuess/" + ds.user_id , {
...
signInForm.addEventListener('submit', (event) => {
    ...
    try {
    ds = DaveService.login("https://test.iamdave.ai", "student_test",document.getElementById("username").value , document.getElementById("password").value,{"signup_apikey": "c3R1ZGVudF90ZXN0MTY4NjY0MjA3OC40Mw__"})
    loadGame();
    }
    catch {
...
signUpForm.addEventListener('submit', (event) => {
    ...
    }, (data) => {console.log(data)},  (data) => {console.log(data)}).then(loadGame);
});
